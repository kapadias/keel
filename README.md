...
<p align="center">
  ...
  <sub>A drop-in <code>.claude/</code> harness for Claude Code. Hooks and scripts, not polite requests: 286 golden tests prove every gate blocks what it should and lets through what it should.</sub>
</p>
